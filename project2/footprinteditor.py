...
def display_about_messagebox(event = None):
    tkinter.messagebox.showinfo(
        "About", PROGRAM_NAME + "\nTkinter GUI Application\n By Jóhannes Guðjónsson")

def display_help_messagebox(event = None):
    tkinter.messagebox.showinfo(
        'Help', "Email: \njohannesgujonsson@gmail.com\n Between 17:00-21-00")
